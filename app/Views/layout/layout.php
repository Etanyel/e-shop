  ...
  <style>
    * {
    ...
    #sidebar .nav-link.active {
      ...
      /* semi-transparent white for active */
    }

    /* When sidebar is collapsed */
    #sidebar.collapsed {
      width: 70px;
      /* or whatever width you set */
    }
...
<body>
  <div class="d-flex">
    ...
    <div id="mainContent" class="flex-grow-1">
      ...
      <div class="container-fluid  p-5 shadow rounded">
        <!-- contents -->
