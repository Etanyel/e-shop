...
<div class="container">
    ...
    <form action="/product/search" class="mt-3 form-group d-flex justify-content-between align-items-center" method="GET">
        <?= csrf_field(); ?>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="qty" min="1" class="form-control" value="" placeholder="Quantity:">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="file" name="productImg" class="form-control" id="image">
                                </div>
                            </div>
