                ...
                foreach ($users as $u): ?>
                    <tbody>
                        <tr class="align-items-center">
                            ...
                            <td><?= $u['username'] ?></td>
                            <td><?= $u['contact'] ?></td>
                            <td><a data-bs-target="#img<?= $u['photo'] ?>" data-bs-toggle="modal"
                    ...
                    <div class="modal fade" id="edit_<?= $u['user_id'] ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/admin/users/update/<?= $u['user_id'] ?>" method="POST"
                                    ...
                                    <div class="modal-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="fname" placeholder="Firstname Here"
                                                    value="<?= htmlspecialchars($u['firstname']) ?>" class="form-control">
                                            </div>
                                            <div class="col-6">
                                                <label for="" class="form-label">Lastname</label>
                                                <input type="text" name="lname" placeholder="Lastname Here"
                                                    value="<?= htmlspecialchars($u['lastname']) ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="username" placeholder="Username Here"
                                                    value="<?= htmlspecialchars($u['username']) ?>" class="form-control">
                                            </div>
                                            <div class="col-6">
                                                <label for="" class="form-label">Contact</label>
                                                <input type="number" name="contact" placeholder="Contact No. Here"
                                                    value="<?= htmlspecialchars($u['contact']) ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <select name="role" value="" class="form-select">
                                                ...
                                                <option value="employee" <?= 'employee' == $u['role'] ? 'selected' : '' ?>>Employee
                                                </option>
                                            </select>
                                        </div>
                    ...
                    <!-- DEFAULT PASSWORD -->
                    <div class="modal fade" id="default_<?= $u['user_id'] ?>">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
