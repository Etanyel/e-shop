    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 mt-3">
        ...
        ?>
                ...
                <a style="text-decoration: none;" data-bs-toggle="modal" data-bs-target="#productModal<?= esc($p['product_id']) ?>" href="#">
                    <div class="card h-100 shadow-lg">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <p class="fw-bold">₱<?= esc(number_format(esc($p['price']), 2)) ?></p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="modal fade" id="productModal<?= esc($p['product_id']) ?>" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <img src="uploads/<?= esc($p['photo']) ?>" class="img-fluid rounded" alt="Product Image">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#EditModal<?= esc($p['product_id']) ?>" class="btn btn-outline-success rounded-circle me-4"><i class="bi bi-pencil"></i></button>
                                ...
                                <!-- Edit Modal -->
                <div class="modal fade" id="EditModal<?= esc($p['product_id']) ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="product/update/<?= esc($p['id']) ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <?php else : 
                                                ...
                                                <label for="productName" class="form-label"><?= $category ?></label>
                                            <?php endif; ?>
                                            <input type="text" name="productName" placeholder="<?= $category ?>" value="<?= esc($p['product_name']) ?>" class="form-control">
                                        </div>  

                                        <div class="col-6">
                                            <label for="" class="form-label">Category</label>
                                            <input type="text" name="" value="<?= ucfirst(esc($p['category'])) ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <?php if(esc($p['category']) === 'pet') : ?>
                                        <div class="row mb-2">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="species" value="<?= esc($p['species']) ?>" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <label for="breed" class="form-label">Breed</label>
                                                <input type="text" name="breed" value="<?= esc($p['breed']) ?>" class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <label for="age" class="form-label">Age</label>
                                                <input type="text" name="age" value="<?= esc($p['age']) ?>" class="form-control">
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="qty" value="<?= esc($p['qty']) ?>" class="form-control">
                                        </div>

                                        <div class="col-6">
                                            <label for="price" class="form-label">Price</label>
                                            <input type="text" name="price" value="<?= esc($p['price']) ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="description" value="<?= esc($p['description']) ?>" placeholder="Description Here" class="form-control"><?= esc($p['description']) ?></textarea>
                                    </div>
                                    
                                    <div class="">
                                        <label for="photo" class="form-label">Update Photo</label>
                                        <input type="file" name="photo" value="<?= esc($p['photo']) ?>" class="form-control">
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <span class="btn btn btn-secondary" data-bs-target="#productModal<?= esc($p['product_id']) ?>" data-bs-toggle="modal">Back</span>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="deleteModal<?= esc($p['product_id']) ?>">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <form action="/product/delete/<?= esc($p['id']) ?>" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <span class="btn btn-secondary" data-bs-target="#productModal<?= esc($p['product_id']) ?>" data-bs-toggle="modal">Cancel</span>
                            </div>
                        </form>
                        </div>
                    </div>
