...
<div class="container">
    ...
    <h3 class="mt-2">Sold Out Products</h3>
    <hr>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        <?php if ($soldProduct): ?>
            <?php foreach ($soldProduct as $s): ?>
                <div class="col">
                    <a style="text-decoration:none;" data-bs-toggle="modal" data-bs-target="#modal<?= esc($s['product_id']) ?>"
                        href="">
                        <div class="card shadow-lg h-100">
                            <img src="uploads/<?= esc($s['photo']) ?>" style="height: 200px; width: 100%; object-fit: cover;"
                                alt="img">
                ...
                <div class="modal fade" id="modal<?= esc($s['product_id']) ?>" tabindex="-1" aria-labelledby="productModalLabel"
                    aria-hidden="true">
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-6 text-center">
                                        <img src="uploads/<?= esc($s['photo']) ?>" class="img-fluid rounded"
                                            alt="Product Image">
                                    </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus"
                                                    data-bs-content="Re-Stock Product" data-bs-placement="top"
                                                    data-bs-container="body"><button
                                                        class="btn btn-outline-success rounded-circle me-2"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#restock_<?= $s['product_id'] ?>"><i
                                                            class="bi bi-box2-fill"></i></button></span>
                                                <!-- Delete Btn -->
                                                <span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus"
                                                    data-bs-content="Remove Product" data-bs-placement="top"
                                                    data-bs-container="body"><button
                                                        class="btn btn-outline-danger rounded-circle me-2"
                                                        data-bs-toggle="modal"
                                                ...
                                                <span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus"
                                                    ...
                                                    data-bs-container="body"><button data-bs-toggle="modal"
                                                        data-bs-target="#EditModal<?= esc($s['product_id']) ?>"
                                                        class="btn btn-outline-primary rounded-circle me-4"><i
                        ...
                        <div class="modal-content">
                            ...
                            <form action="/sold_out/restock/<?= esc($s['id']) ?>" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="number" name="qty" min="1" id="" class="form-control"
                                        placeholder="Insert Quantity">
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-success">Re-Stock</button>
                                    <span class="btn btn-secondary" data-bs-target="#modal<?= esc($s['product_id']) ?>"
                                        data-bs-toggle="modal">Cancel</span>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                ...
                                <button class="btn-close" data-bs-target="#modal<?= esc($s['product_id']) ?>"
                                ...
                                <div class="modal-body">
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="productName" placeholder="<?= $category ?>"
                                                value="<?= esc($s['product_name']) ?>" class="form-control">
                                        </div>

                                        <div class="col-6">
                                            <label for="" class="form-label">Category</label>
                                            <input type="text" name="" value="<?= esc(ucfirst($s['category'])) ?>"
                                    ...
                                    <?php if (esc($s['category']) === 'pet'): ?>
                                        <div class="row mb-2">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="species" value="<?= esc($s['species']) ?>"
                                                    class="form-control">
                                            </div>

                                            <div class="col-md-4">
                                                <label for="breed" class="form-label">Breed</label>
                                                <input type="text" name="breed" value="<?= esc($s['breed']) ?>"
                                                    class="form-control">
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="price" value="<?= esc($s['price']) ?>"
                                                class="form-control">
                                        </div>
                                        <div class="col-6">
                                            <label for="status" class="form-label">Status</label>
                                            <input type="text" name="status"
                                                value="<?= esc(str_replace('_', ' ', $s['status'])) ?>" class="form-control"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="description" placeholder="Description Here"
                                            class="form-control"><?= esc($s['description']) ?></textarea>
                                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header bg-danger">
                                ...
                                <span class="btn btn-close" data-bs-target="#modal<?= esc($s['product_id']) ?>"
